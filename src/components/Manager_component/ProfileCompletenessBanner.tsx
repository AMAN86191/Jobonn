...
const ProfileCompletenessBanner: React.FC<ProfileCompletenessBannerProps> = ({ user, navigation }) => {
  const completeness = user ? getProfileCompleteness(user) : null;
  ...
  const companyId = user.company_id || user.company?.id || user.companyid || user.id || '';
      ...
      <View style={styles.profileBannerContent}>
        <View style={styles.profileBannerLeft}>
          ...
          <Text style={styles.profileBannerSub}>
            Fill in your company details to start posting jobs and hire top talent.
          </Text>
        </View>
